...
<div style="margin-bottom: 30px;">
    ...
    <div style="margin: 15px 0;">
        ...
        <a href="{{ route('admin.boards.create') }}" style="display: inline-block; padding: 10px 20px; background: #D6DAF0; border: 1px solid #B7C5D9; text-decoration: none; color: #000;">Create New Board</a>
    </div>
</div>
